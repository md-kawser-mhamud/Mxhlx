...
export default function Home() {
  return (
    <main className="relative h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-gray-950 via-gray-900 to-black px-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <Link 
          href="/blog" 
          className="px-8 py-3 bg-gray-800 text-white font-semibold rounded-lg hover:bg-gray-700 transition text-center shadow-lg border border-gray-700"
        >
          Read Blogs
        </Link>
        <a 
